...
%%
range_select_idx = 24;
%ilb = testranges(range_select_idx, 1);
%iub = testranges(range_select_idx, 2);

ilb = 0.445721888;%testranges(range_select_idx, 1);
iub = 0.588133557758482;%testranges(range_select_idx, 2);
